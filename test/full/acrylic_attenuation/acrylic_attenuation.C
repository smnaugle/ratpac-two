void acrylic_attenuation(std::string event_filename, std::string out_filename) {
  ...
  T->Draw("mc.track.GetLastMCTrackStep()->length>>acr_attn_100",
          "TMath::Abs(1.23997279736421566e-03/(mc.track.GetLastMCTrackStep()->ke)-100)<10", "goff");
  ...
  T->Draw("mc.track.GetLastMCTrackStep()->length>>acr_attn_200",
          "TMath::Abs(1.23997279736421566e-03/(mc.track.GetLastMCTrackStep()->ke)-200)<10", "goff");
  ...
  T->Draw("mc.track.GetLastMCTrackStep()->length>>acr_attn_300",
          "TMath::Abs(1.23997279736421566e-03/(mc.track.GetLastMCTrackStep()->ke)-300)<10", "goff");
  ...
  T->Draw("mc.track.GetLastMCTrackStep()->length>>acr_attn_400",
          "TMath::Abs(1.23997279736421566e-03/(mc.track.GetLastMCTrackStep()->ke)-400)<10", "goff");
  ...
  T->Draw("mc.track.GetLastMCTrackStep()->length>>acr_attn_500",
          "TMath::Abs(1.23997279736421566e-03/(mc.track.GetLastMCTrackStep()->ke)-500)<10", "goff");
